...
public class Restaurant6 extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_restaurant6); //correct layout
        ...
        //restaurant id
        String[] menuItems = db.getMenuItems(6);
        ...
        btnConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Restaurant6.this, User_ConfirmOrder.class));
            }
        });
    ...
    public void onItemClick(View view, int position) {
        ...
        String[] menuItems2 = db.getMenuItems(6);
